            ...
            switch (mainMenu) {
                case 1:
                    ...
                    if (ConsoleIO.promptForBool("(Yes/No)","Yes","No")) {
                        SetUp.newGame();
                        System.out.println("");
                        SetUp.reader("C:\\Users\\Bryan\\Documents\\My Games\\Dungeon Master\\Dialogue\\Intro.txt");
                        scanner.nextLine();
                        SetUp.reader("C:\\Users\\Bryan\\Documents\\My Games\\Dungeon Master\\Dialogue\\Intro2.txt");
                        scanner.nextLine();
                        cont = false;
                        System.out.println("");
                        Players.printPlayer();
